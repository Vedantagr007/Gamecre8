    ...
    <nav className="navbar navbar-expand-lg">
      <div className="container-fluid px-5">
        <div className="navbar-brand d-flex align-items-center">
          ...
          />
          <span className="ms-3 flex items-center font-orelega text-4xl text-transparent bg-clip-text fw-bold" style={{
            color: "#7C49BE",
          ...
          <div className="d-flex align-items-center">
            {!login ? (
              <button
                ...
                onMouseEnter={(e) => (e.target.style.backgroundColor = "#B40090")}
                onMouseLeave={(e) => (e.target.style.backgroundColor = "#7C49BE")}
              >
